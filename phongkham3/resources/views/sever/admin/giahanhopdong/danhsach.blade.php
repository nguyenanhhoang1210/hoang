            ...
            <tr class="odd gradeX" align="center">
              ...
              <td>
                ...
                @if ($gh->trangthai=="Hết Hiệu Lực")
                  <span class="badge alert-danger">{{$gh->trangthai}}</span>
                @endif
                @if ($gh->trangthai=="Chấm Dứt")
                  <span class="badge badge-danger">{{$gh->trangthai}}</span>
                @endif
              </td>
              <td class="center"><i class="fa fa-trash-o  fa-fw"></i><a onclick="return confirmAction()" href="sever/admin/giahan/xoa/{{$gh->maGH}}"> Delete</a></td>
              <td class="center"><i class="fa fa-pencil fa-fw"></i> <a href="sever/admin/giahan/sua/{{$gh->maGH}}">Edit</a></td>
            </tr>
            @endforeach
          </tbody>
        </table>
