                    ...
                    <div class="content-heading">
                        <div class="dropdown float-right">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="ecom-dashboard-stats-drop">
                                <a class="dropdown-item " href="sever/admin/thongke/today">
                                ...
                                <a class="dropdown-item active" href="sever/admin/thongke/all">
                            ...
                            <a class="block block-rounded block-transparent bg-gd-elegance" href="javascript:void(0)">
                                <div class="block-content block-content-full block-sticky-options">
                                    ...
                                    <div class="py-20 text-center">
                                        ...
                                        <div class="font-size-sm font-w600 text-uppercase text-white-op">Phòng Khám</div>
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            <a class="block block-rounded block-transparent bg-gd-dusk" href="javascript:void(0)">
                                <div class="block-content block-content-full block-sticky-options">
                                    ...
                                    <div class="py-20 text-center">
                                        ...
                                        <div class="font-size-sm font-w600 text-uppercase text-white-op">Hợp Đồng</div>
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            <a class="block block-rounded block-transparent bg-gd-sea" href="javascript:void(0)">
                                <div class="block-content block-content-full block-sticky-options">
                                    ...
                                    <div class="py-20 text-center">
                                        ...
                                        <div class="font-size-sm font-w600 text-uppercase text-white-op">Gia Hạn</div>
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            <a class="block block-rounded block-transparent bg-gd-aqua" href="javascript:void(0)">
                                <div class="block-content block-content-full block-sticky-options">
                                    ...
                                    <div class="py-20 text-center">
                                        ...
                                        <div class="font-size-sm font-w600 text-uppercase text-white-op">Người Đăng Ký</div>
                                    </div>
                                </div>
                            </a>
                        </div>
