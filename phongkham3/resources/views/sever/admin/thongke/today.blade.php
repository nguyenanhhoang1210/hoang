                    ...
                    <div class="content-heading">
                        <div class="dropdown float-right">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="ecom-dashboard-stats-drop">
                                <a class="dropdown-item active" href="sever/admin/thongke/today">
                                    <i class="fa fa-fw fa-calendar mr-5"></i>Today
                                </a>
                                <a class="dropdown-item" href="sever/admin/thongke/thisweek">
                                    <i class="fa fa-fw fa-calendar mr-5"></i>This Week
                                </a>
                                <a class="dropdown-item" href="sever/admin/thongke/thismonth">
                                    <i class="fa fa-fw fa-calendar mr-5"></i>This Month
                                </a>
                                <a class="dropdown-item" href="sever/admin/thongke/thisyear">
                                    <i class="fa fa-fw fa-calendar mr-5"></i>This Year
                                </a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="sever/admin/thongke/all">
                        ...
                        <div class="col-md-6 col-xl-4">
                            <a class="block block-rounded block-transparent bg-gd-sun" href="javascript:void(0)">
                                <div class="block-content block-content-full block-sticky-options">
                                    ...
                                    <div class="py-20 text-center">
                                        <div class="font-size-h2 font-w700 mb-0 text-white" data-toggle="countTo" data-to="{{ $demghhl }}">0</div>
                                        <div class="font-size-sm font-w600 text-uppercase text-white-op">HĐ gần hết hiệu lực</div>
                                    </div>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <a class="block block-rounded block-transparent bg-gd-lake" href="javascript:void(0)">
                                <div class="block-content block-content-full block-sticky-options">
                                    ...
                                    <div class="py-20 text-center">
                                        <div class="font-size-h2 font-w700 mb-0 text-white" data-toggle="countTo" data-to="{{ $demtgh }}">0</div>
                                        <div class="font-size-sm font-w600 text-uppercase text-white-op">HĐ trễ gia hạn</div>
                                    </div>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <a class="block block-rounded block-transparent bg-gd-sea" href="javascript:void(0)">
                                <div class="block-content block-content-full block-sticky-options">
                                    ...
                                    <div class="py-20 text-center">
                                        <div class="font-size-h2 font-w700 mb-0 text-white" data-toggle="countTo" data-to="{{ $demhhl }}">0</div>
                                        <div class="font-size-sm font-w600 text-uppercase text-white-op">HĐ hết hiệu lực</div>
                                    </div>
                                </div>
                            </a>
                        </div>
