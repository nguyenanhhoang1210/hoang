                    ...
                    <div class="hero-static content content-full bg-white invisible" data-toggle="appear">
                        ...
                        <div class="row justify-content-center px-5">
                            <div class="col-sm-8 col-md-6 col-xl-4">
                                ...
                                <form class="js-validation-reminder" action="sever/quenmatkhau" method="post">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <div class="form-material floating">
                                                <input class="form-control" id="reminder-credential" name="email" type="Email" required="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a class="btn btn-block btn-noborder btn-rounded btn-alt-secondary" href="sever/dangnhap">
