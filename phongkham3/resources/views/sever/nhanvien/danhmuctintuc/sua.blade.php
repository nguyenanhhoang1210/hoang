        ...
        <div class="col-md-9">
            ...
            <div class="block">
                ...
                <div class="block-content">
                    ...
                    @endif
                    <form action="sever/nhanvien/danhmuctintuc/sua/{{ $danhmuctintuc->id }}" method="POST">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <div class="form-group">
                            <label>Tên Danh Mục Tin Tức</label>
                            <input class="form-control" name="Ten" placeholder="Điền thông tin cần sửa " value="{{ $danhmuctintuc->Ten }}" required=""/>
                        </div>
                        <div class="form-group">
