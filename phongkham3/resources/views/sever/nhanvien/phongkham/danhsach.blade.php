  ...
  <div class="content">
    ...
    <div class="block">
      <div class="block-header block-header-default">
       <button type="button" class="btn btn-dual-secondary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        Danh Sách
      </button>
      <div class="dropdown-menu min-width-200" aria-labelledby="page-header-user-dropdown">
        <a class="dropdown-item" href="sever/nhanvien/ajax/phongkham/on">Trạng Thái Mở</a>
        <a class="dropdown-item" href="sever/nhanvien/ajax/phongkham/off">Trạng Thái Tắt</a>
        <a class="dropdown-item" href="sever/nhanvien/phongkham/danhsach">Tất Cả</a>
      </div>
    </div>
