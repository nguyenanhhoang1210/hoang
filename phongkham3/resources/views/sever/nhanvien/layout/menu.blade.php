                    ...
                    <div id="sidebar-scroll">
                        ...
                        <div class="sidebar-content">
                            ...
                            <div class="content-side content-side-full">
                                <ul class="nav-main">
                                    <li>
                                        <a class="active" href="sever/nhanvien/thongke/today">
                                            <i class="si si-cup"></i>
                                    ...
                                    <li>
                                        <a class="nav-submenu" data-toggle="nav-submenu" href="#">
                                            ...
                                            <span class="sidebar-mini-hide">Phòng Khám</span>
                                        </a>
                                        <ul>
                                            <li>
                                                <a href="sever/nhanvien/phongkham/them">Thêm</a>
                                            </li>
                                            <li>
                                                <a href="sever/nhanvien/phongkham/danhsach">Quản lý</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                        ...
                                        <ul>
                                            <li>
                                                <a href="sever/nhanvien/hopdong/danhsach">Quản lý</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                        ...
                                        <ul>
                                            <li>
                                                <a href="sever/nhanvien/giahan/danhsach">Quản lý</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a class="nav-submenu" data-toggle="nav-submenu" href="#">
                                            ...
                                            <span class="sidebar-mini-hide">Users Đăng Ký</span>
                                        </a>
                                        <ul>
                                            <li>
                                                <a href="sever/nhanvien/nguoidangky/them">Thêm</a>
                                            </li>
                                            <li>
                                                <a href="sever/nhanvien/nguoidangky/danhsach">Quản lý</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a class="nav-submenu" data-toggle="nav-submenu" href="#">
                                            ...
                                            <span class="sidebar-mini-hide">Chuyên Khoa</span>
                                        </a>
                                        <ul>
                                            <li>
                                                <a href="sever/nhanvien/chuyenkhoa/them">Thêm</a>
                                            </li>
                                            <li>
                                                <a href="sever/nhanvien/chuyenkhoa/danhsach">Quản lý</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a class="nav-submenu" data-toggle="nav-submenu" href="#">
                                            ...
                                            <span class="sidebar-mini-hide">Loại Dịch Vụ</span>
                                        </a>
                                        <ul>
                                            <li>
                                                <a href="sever/nhanvien/loaidichvu/them">Thêm</a>
                                            </li>
                                            <li>
                                                <a href="sever/nhanvien/loaidichvu/danhsach">Quản lý</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a class="nav-submenu" data-toggle="nav-submenu" href="#">
                                            ...
                                            <span class="sidebar-mini-hide">Dịch Vụ</span>
                                        </a>
                                        <ul>
                                            <li>
                                                <a href="sever/nhanvien/dichvu/them">Thêm</a>
                                            </li>
                                            <li>
                                                <a href="sever/nhanvien/dichvu/danhsach">Quản lý</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a class="nav-submenu" data-toggle="nav-submenu" href="#">
                                            ...
                                            <span class="sidebar-mini-hide">Danh Mục Tin Tức</span>
                                        </a>
                                        <ul>
                                            <li>
                                                <a href="sever/nhanvien/danhmuctintuc/them">Thêm</a>
                                            </li>
                                            <li>
                                                <a href="sever/nhanvien/danhmuctintuc/danhsach">Quản lý</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a class="nav-submenu" data-toggle="nav-submenu" href="#">
                                            ...
                                            <span class="sidebar-mini-hide">Tin Tức</span>
                                        </a>
                                        <ul>
                                            <li>
                                                <a href="sever/nhanvien/tintuc/them">Thêm</a>
                                            </li>
                                            <li>
                                                <a href="sever/nhanvien/tintuc/danhsach">Quản lý</a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li>
                                        <a href="sever/nhanvien/sua/{{ $user_login->id }}">
                                    ...
                                    {{-- <li class="nav-main-heading">
                                        <span class="sidebar-mini-visible">MR</span>
                                        <span class="sidebar-mini-hidden">More</span>
                                    </li>
                                    <li>
                                        <a href="">
