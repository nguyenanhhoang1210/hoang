        ...
        <div class="col-md-9">
            ...
            <div class="block">
                ...
                <div class="block-content">
                    ...
                    @endif
                    <form action="sever/nhanvien/giahan/them/{{ $hopdong->maHD }}" method="POST">

                        <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
                        <div class="form-group">
                            <label>Mã Gia Hạn</label>
                            <input class="form-control" name="maGH" placeholder="Mời bạn nhập mã gia hạn" required=""/>
                        </div>
                        <div class="form-group">
                            <label>Mã Hợp Đồng</label>
                            <input class="form-control" name="maHD" disabled="" required="" value="{{ $hopdong->maHD }}" />
                        </div>
                        <div class="form-group">
                            <label>Giá Trị</label>
