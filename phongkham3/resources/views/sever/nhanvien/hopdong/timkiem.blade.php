          ...
          <tbody>
            ...
            <tr class="odd gradeX" align="center">
              ...
              <td>
                ...
                <span><a class="badge badge-warning" onclick="return confirmAction1()" href="sever/nhanvien/hopdong/thongbao/{{ $hd->maHD }}">{{$hd->trangthai}}</a></span>
                @endif
                @if ($hd->trangthai=="Trễ Gia Hạn")
                <span><a class="badge badge-info" onclick="return confirmAction1()" href="sever/nhanvien/hopdong/thongbao/{{ $hd->maHD }}">{{$hd->trangthai}}</a></span>
                @endif
                @if ($hd->trangthai=="Hết Hiệu Lực")
                <span><a class="badge alert-danger" onclick="return confirmAction1()" href="sever/nhanvien/hopdong/thongbao/{{ $hd->maHD }}">{{$hd->trangthai}}</a></span>
                @endif
                @if ($hd->trangthai=="Chấm Dứt")
                <span class="badge badge-danger">{{$hd->trangthai}}</span>
                @endif
              </td>
              <td class="center"><i class="fa fa-trash-o  fa-fw"></i><a onclick="return confirmAction()" href="sever/nhanvien/hopdong/xoa/{{$hd->maHD}}"> Delete</a></td>
              <td class="center"><i class="fa fa-pencil fa-fw"></i> <a href="sever/nhanvien/hopdong/sua/{{$hd->maHD}}">Edit</a></td>
              <td class="center"><i class="fa fa-plus-square-o"></i> <a href="sever/nhanvien/giahan/them/{{$hd->maHD}}">Add</a></td>
            </tr>
            @endforeach
          </tbody>
        </table>
